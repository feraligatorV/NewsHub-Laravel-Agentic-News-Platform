...
NewsHub concentra backend, frontend integrado y API en una sola aplicacion Laravel. Los usuarios interactuan mediante navegador y los endpoints privados requieren autenticacion con `JWT`.
